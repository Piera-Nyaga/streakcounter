...
let best = document.getElementById('showup');
let btnAdd = document.getElementById('adds');
let Info = document.getElementById('pr');
let pr = document.getElementById('pp');
let Form = document.getElementById('form');
let btnReset = document.getElementById('resets');
let Err = document.getElementById('err');
let Title1 = document.getElementById('title');
let Image1 = document.getElementById('image');
let Date1 = document.getElementById('date');
let btnAdds = document.getElementById('addts');
let Display = document.getElementById('display');
let displayOne = document.getElementById('dispOne');
let Tasks = [];
let bestStreak;
class Streak {
...
btnAdds.addEventListener('click', e => {
    ...
    function addtask() {
        ...
        if (Title == '' || Image == '' || date == '') {
            ...
            let singleTask = { Title, Image, date, Days, id: Math.random() * 10000 };
...
function popOne(id) {
    ...
    const onetask = Tasks.filter(a => a.id === id);
